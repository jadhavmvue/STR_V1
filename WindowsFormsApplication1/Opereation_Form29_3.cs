...
{
    public partial class Opereation_Form29_3 : Form
    {
        ...
        public Opereation_Form29_3(string id, int i)
        {
            InitializeComponent();
            userid = id;
            rowId = i;
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (HourMD <= 24 && MinMD <= 60 && SecMD <= 60)
                    {
                        ...
                        {
                            var query = "insert into tbldata_29_3 (batchno, cubeno, initialwt, castdate, ageinhr, date, laodinkn, strength, mbatch) values ('" + textBox1.Text.Trim() + "', '" + textBox2.Text.Trim() + "', '" + textBox3.Text.Trim() + "','" + dateTimePicker1.Value.ToString("yyyy-MM-dd") + "', '" + textBox4.Text.Trim() + "','" + AllDate + "','" + textBox5.Text.Trim() + "','" + textBox6.Text.Trim() + "','" + textBox1.Text.Trim() + "');";
