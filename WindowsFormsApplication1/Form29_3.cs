...
{
    public partial class Form29_3 : Form
    {
        ...
        void gridfill()
        {
            try
            {
                ...
                GlobalClass.adap = new MySqlDataAdapter("SELECT mbatch as `Batch No`, cubeno as `Cube No`, initialwt as `Initial Wt`, castdate as `castdate`, ageinhr as `Age In Hr`, `date` as Date, laodinkn as `Load In Kn`, strength as `Strength` FROM tbldata_29_3 where mbatch = '" + batch + "' ;", myConn7);
        ...
        private void dataGridView1_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Opereation_Form29_3 op = new Opereation_Form29_3(str, i);
            op.Show();
        }
