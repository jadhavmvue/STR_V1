...
namespace WindowsFormsApplication1
{
    public partial class Form3 : Form
    {
        ...
        {
            if (batchnotxt.Text == "" || wirelentxt.Text == "" || crosstxt.Text == "" || textBox5.Text == "" || youngsmodtxt.Text == "" || comboBox3.Items.Count < 1 || comboBox3.SelectedItem.ToString() == "" || tensioncombo.SelectedItem.ToString()=="")
    ...
    //  ComPort.Close();
        ...
        private void timer1_Tick_1(object sender, EventArgs e)
        {
                    ...
                    switch (chemberno)
                    {
                        ...
                        case 28:
                            ...
                            if (len == 73)
                            {
                                ...
                                string mf1 = temp[i].Substring(52, 5);
                                string mf2 = temp[i].Substring(57, 5);
                                string mix_design = temp[i].Substring(62, 2);
                                ...
                                string query = "INSERT INTO tbldata_28_2 ( batchno, sleeperno, date, castdate, top, bottom, mr1, mr2, mf1, mf2,mbatch,mix_design) VALUES('"
                                                                 + batchnotxt.Text + "','" + sleeper_no + "','" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "','" + castdate + "','" + top + "','" + bottom + "','" + mr1 + "','" + mr2 + "','" + mf1 + "','" + mf2 + "','" + batch + "','" + mix_design + "');";
                                MySqlCommand cmd = new MySqlCommand(query, connection);
                        ...
                        case 29:
                            ...
                            {//First report mortar
                                ...
                                string testdate = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
                                string loadkn = temp[i].Substring(39, 4);
                                string mix_design = temp[i].Substring(43, 2);
                                double straingth=(Convert.ToDouble(loadkn)*0.204);
                            ...
                            {//third table steam curing
                                ...
                                string query = "INSERT INTO tbldata_29_3 ( batchno, cubeno, initialwt, castdate, ageinhr, date, laodinkn, strength,mbatch) VALUES('"
                                              + batchnotxt.Text + "','" + cubeno + "','" + wt + "','" + (castdate.Substring(4, 2) + "-" + castdate.Substring(2, 2) + "-" + castdate.Substring(0, 2)) + "','" + ageinhr + "',' " + testdate + " ','" + loadkn + "'," + straingth.ToString("0.###") + ",'" + batch + "');";
                                if (connection.State == ConnectionState.Closed)
                                    connection.Open();
                                MySqlCommand cmd = new MySqlCommand(query, connection);
                            ...
                            {//third table steam curing
                                ...
                                string testdate = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
                                string loadkn = temp[i].Substring(44, 4);
                                string mix_design = temp[i].Substring(48, 2);
                                double straingth = (Convert.ToDouble(loadkn) / 22.5);
                                ...
                                string query = "INSERT INTO tbldata_29_3 ( batchno, cubeno, initialwt, castdate, ageinhr, date, laodinkn, strength,mbatch,mix_design) VALUES('"
                                              + batchnotxt.Text + "','" + cubeno + "','" + wt + "','" + (castdate.Substring(4, 2) + "-" + castdate.Substring(2, 2) + "-" + castdate.Substring(0, 2)) + "','" + ageinhr + "',' " + testdate + " ','" + loadkn + "'," + straingth.ToString("0.###") + ",'" + batch + "','" + mix_design + "');";
                                if (connection.State == ConnectionState.Closed)
                                    connection.Open();
                                MySqlCommand cmd = new MySqlCommand(query, connection);
                            ...
                            {// second Water cube test
                                ...
                                string ageindays = temp[i].Substring(28, 4);
                                string testdate = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
                                string loadkn = temp[i].Substring(44, 4);
                                double straingth = (Convert.ToDouble(loadkn)/22.5);
                                ...
                                string query = "INSERT INTO tbldata_29_2 (  batchno, cubeno, initialwt, castdate, ageindays, `date`, laodinkn, strength,mbatch) VALUES('"
                                                + batchnotxt.Text + "','" + cubeno + "','" + wt + "','" + (castdate.Substring(4, 2) + "-" + castdate.Substring(2, 2) + "-" + castdate.Substring(0, 2)) + "','" + ageindays + "',' " + testdate + " ','" + loadkn + "'," + straingth.ToString("0.###") +",'" + batch + "');";
                                MySqlCommand cmd = new MySqlCommand(query, connection);
                            ...
                            {// second Water cube test
                                ...
                                if (connection.State == ConnectionState.Closed)
                                    connection.Open();
                                string query = "INSERT INTO tbldata_29_2 (  batchno, cubeno, initialwt, castdate, ageindays, `date`, laodinkn, strength,mbatch,mix_design) VALUES('"
                                                + batchnotxt.Text + "','" + cubeno + "','" + wt + "','" + (castdate.Substring(4, 2) + "-" + castdate.Substring(2, 2) + "-" + castdate.Substring(0, 2)) + "','" + ageindays + "',' " + testdate + " ','" + loadkn + "'," + straingth.ToString("0.###") + ",'" + batch + "','" + mix_design + "');";
                                MySqlCommand cmd = new MySqlCommand(query, connection);
                        ...
                        case 30:
                            {
                                if (len == 42)
                                {
                                    ...
                                    string query = "INSERT INTO tbldata_30 ( batchno, castdate, sleeperno, ageindays, date, loadinkn, strength,mbatch) VALUES('"
                                                       + batchnotxt.Text + "','" + castdate + "','" + beam + "','" + ageindays+ "','" + testdate + "',' " + loadkn + " ','"  + straingth + "','"+batch+"');";
                                    MySqlCommand cmd = new MySqlCommand(query, connection);
                                ...
                                if (len == 51)
                                {
                                    ...
                                    string query = "INSERT INTO tbldata_30 ( batchno, castdate, sleeperno, ageindays, date, loadinkn, strength,mbatch,mix_design) VALUES('"
                                                       + batchnotxt.Text + "','" + castdate + "','" + beam + "','" + ageindays + "','" + testdate + "',' " + loadkn + " ','" + straingth + "','" + batch + "','" + mix_design + "');";
                                    MySqlCommand cmd = new MySqlCommand(query, connection);
                        ...
                        case 31:
                            if(len==35)
                            {
                                ...
                                string addmix = temp[i].Substring(28, 5);
                            ...
                            if (len == 54)
                            {
                                ...
                                if (tensioncombo.SelectedIndex == 0)
                                    query = "INSERT INTO tbldata_32 (batchno, castno, benchno, intialread, rlu, rll, rru, rrl, frlu, frll, frru, frrl, wirelength, cross_section, youngsmodulus, elongation, elongationkn, prestress,mbatch,`date`) VALUES('"
                                                + batchnotxt.Text + "','" + cast + "','" + bench + "','" + initialread + "','" + rlu + "',' " + rll + " ','" + rru + "','" + rrl + "','" + flu + "','" + fll + "','" + fru + "','" + frl + "','" + wirelen + "','" + crosstxt.Text + "','" + youngsmodtxt.Text + "','" + elong + "','" + p + "','" + c + "','" + batch + "','" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "');";
                                else
            ...
            catch(Exception asd) { //MessageBox.Show("Something Went Wrong"); 
            }
...
//*************************Commented because of Chandil cycle goes over 12 hr*********************************
            ...
            //---------------If u want leave the batchno & get it new Batch no then remove below else if (asd[chemberno].StartsWith("#")) from comment
