...
{
    public partial class Opereation_Form29_1 : Form
    {
        ...
        public Opereation_Form29_1(string id, int i)
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (textBox1.Text.Trim() == "" || textBox2.Text.Trim() == "" || dateTimePicker1.Text.Trim() == "" || dateTimePicker2.Text.Trim() == "" || textBox5.Text.Trim() == "" || textBox6.Text.Trim() == "")
                {
                ...
                else
                {
                    ...
                    if (HourMD <= 24 && MinMD <= 60 && SecMD <= 60 && HourMD1 <= 24 && MinMD1 <= 60 && SecMD1 <= 60)
                    {
                        ...
                        {
                            var query = "insert into tbldata_29_1 (batchno, cubeno, castdate, `date`, loadinkn, strength, mbatch) values ('" + textBox1.Text.Trim() + "', '" + textBox2.Text.Trim() + "','" + AllDate1 + "','" + AllDate + "','" + textBox5.Text.Trim() + "','" + textBox6.Text.Trim() + "','" + textBox1.Text.Trim() + "');";
                ...
                //GlobalClass.adap.Update(GlobalClass.dt);
                  HourMD = Convert.ToInt32(textBox19.Text);
                    ...
                    if (HourMD <= 24 && MinMD <= 60 && SecMD <= 60)
                    {
                        ...
                        if (result == DialogResult.Yes)
                        {
                            var query = "update tbldata_29_1 set batchno = '" + textBox1.Text.Trim() + "', cubeno = '" + textBox2.Text.Trim() + "', `castdate`= '" + AllDate1 + "', `date`= '" + AllDate + "', loadinkn= '" + textBox5.Text.Trim() + "', strength= '" + textBox6.Text.Trim() + "' , mbatch = '" + textBox1.Text.Trim() + "' where mbatch='" + update_txtBox1 + "' and cubeno = '" + update_txtBox2 + "' and `castdate`= '" + datetimeMD1 + "' and `date`= '" + datetimeMD2 + "'and loadinkn= '" + update_txtBox5 + "'and strength= '" + update_txtBox6 + "';";
                            using (var command = new MySqlCommand(query, myConn))
                            {
                                using (var reader = command.ExecuteReader())
                                {
