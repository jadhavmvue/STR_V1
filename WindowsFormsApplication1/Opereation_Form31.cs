...
{
    public partial class Opereation_Form31 : Form
    {
        string userid = "", datetimeMD = "", update_txtBox1 = "", update_txtBox2 = "", update_txtBox3 = "", update_txtBox4 = "", update_txtBox5 = "", update_txtBox6 = "", update_txtBox7 = "", update_txtBox8 = "";
        int rowId;
        static string sConnectionString = ConfigurationManager.ConnectionStrings["MyConn007"].ConnectionString;
        public MySqlConnection myConn;

        public Opereation_Form31(string id, int i)
        {
            InitializeComponent();
            userid = id;
            rowId = i;
                ...
                else
                {
                    ...
                    if (result == DialogResult.Yes)
                    {
                      ...
                      if (HourMD <= 24 && MinMD <= 60 && SecMD <= 60)
                      {
                          ...
                          var query = "insert into tbldata_31 (`date`, batchno, mixdesign, water, cement, ca1, ca2, fa, addmix, mbatch) values ('" + AllDate+ "','" + textBox1.Text.Trim() + "','" + textBox2.Text.Trim() + "','" + textBox3.Text.Trim() + "','" + textBox4.Text.Trim() + "','" + textBox5.Text.Trim() + "','" + textBox6.Text.Trim() + "','" + textBox7.Text.Trim() + "','" + textBox8.Text.Trim() + "','" + textBox1.Text.Trim() + "');";
                ...
                if (result == DialogResult.Yes)
                {
                     int  HourMD = Convert.ToInt32(textBox19.Text);
                      ...
                      if (HourMD <= 24 && MinMD <= 60 && SecMD <= 60)
                      {
                          ...
                          var query = "update tbldata_31 set `date`= '" + AllDate + "', batchno = '" + textBox1.Text.Trim() + "', mixdesign = '" + textBox2.Text.Trim() + "', water= '" + textBox3.Text.Trim() + "', cement= '" + textBox4.Text.Trim() + "', ca1= '" + textBox5.Text.Trim() + "', ca2= '" + textBox6.Text.Trim() + "', fa= '" + textBox7.Text.Trim() + "', addmix= '" + textBox8.Text.Trim() + "', mbatch = '" + textBox1.Text.Trim() + "' where batchno='" + update_txtBox1 + "' and  `date`= '" + datetimeMD + "' and mixdesign = '" + update_txtBox2 + "' and water= '" + update_txtBox3 + "' and cement= '" + update_txtBox4 + "' and ca1= '" + update_txtBox5 + "' and ca2= '" + update_txtBox6 + "' and fa= '" + update_txtBox7 + "' and addmix= '" + update_txtBox8 + "';";
                          using (var command = new MySqlCommand(query, myConn))
                          {
                              using (var reader = command.ExecuteReader())
                              {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                var query = "delete from tbldata_31 where mbatch='" + update_txtBox1 + "' and  `date`= '" + datetimeMD + "' and batchno = '" + update_txtBox1 + "' and mixdesign = '" + update_txtBox2 + "' and water= '" + update_txtBox3 + "' and cement= '" + update_txtBox4 + "' and ca1= '" + update_txtBox5 + "' and ca2= '" + update_txtBox6 + "' and fa= '" + update_txtBox7 + "' and addmix= '" + update_txtBox8 + "';";
                using (var command = new MySqlCommand(query, myConn))
                {
                    using (var reader = command.ExecuteReader())
                    {
