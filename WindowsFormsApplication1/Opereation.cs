...
namespace WindowsFormsApplication1
{
    ...
    {
        string userid = "", datetimeMD1 = "", datetimeMD2 = "", update_txtBox1 = "", update_txtBox2 = "", update_txtBox3 = "", update_txtBox4 = "", update_txtBox5 = "", update_txtBox6 = "", update_txtBox7 = "", update_txtBox8 = "";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        var query = "insert into tbldata_28_1 (batchno, sleeperno, date, castdate, top, bottom, mr1, mr2, mbatch) values ('" + textBox1.Text.Trim() + "', '" + textBox2.Text.Trim() + "','" + dateTimePicker1.Value.ToString("yyyy-MM-dd hh:mm:ss") + "','" + dateTimePicker2.Value.ToString("yyyy-MM-dd") + "','" + textBox5.Text.Trim() + "','" + textBox6.Text.Trim() + "','" + textBox7.Text.Trim() + "','" + textBox8.Text.Trim() + "','" + textBox1.Text.Trim() + "');";
