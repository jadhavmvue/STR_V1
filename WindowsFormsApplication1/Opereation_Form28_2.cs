...
{
    public partial class Opereation_Form28_2 : Form
    {
        ...
        public Opereation_Form28_2(string id, int i)
        {
            InitializeComponent();
            userid = id;
            rowId = i;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        var query = "insert into tbldata_28_2 (batchno, sleeperno, date, castdate, top, bottom, mr1, mr2, mf1, mf2, mbatch) values ('" + textBox1.Text.Trim() + "', '" + textBox2.Text.Trim() + "','" + dateTimePicker1.Value.ToString("yyyy-MM-dd hh:mm:ss") + "','" + dateTimePicker2.Value.ToString("yyyy-MM-dd") + "','" + textBox5.Text.Trim() + "','" + textBox6.Text.Trim() + "','" + textBox7.Text.Trim() + "','" + textBox8.Text.Trim() + "','" + textBox9.Text.Trim() + "','" + textBox10.Text.Trim() + "','" + textBox1.Text.Trim() + "');";
