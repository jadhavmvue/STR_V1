...
{
    public partial class Form32_1 : Form
    {
        ...
        void gridfill()
        {
            try
            {
                ...
                GlobalClass.adap = new MySqlDataAdapter("SELECT batchno as `Batch No`, castno as `Cast No`, `benchno` as `Bench No`, intialread as `Intialread`, rlu as `RLU`, rll as `RLL`, rru as `RRU`, rrl as `RRL`, frlu as `FRLU`, frll as `FRLL`, frru, frrl, wirelength, cross_section, youngsmodulus, elongation, elongationkn, prestress, mbatch, DATE_FORMAT(`date` , '%d/%c/%Y %T')as  `date` FROM tbldata_32 where batchno = '" + batch + "' ;", myConn7);
        ...
        private void dataGridView1_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Opereation_Form32_1 op = new Opereation_Form32_1(str, i);
                    ...
                    try
                    {
                        for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                        {
                            ...
                            try
                            {
                                ...
                                A = Convert.ToDouble(((Cal_rlu + Cal_rrl + Cal_rru + Cal_rrl) / 4));
