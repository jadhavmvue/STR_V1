...
{
    public partial class Form29_1 : Form
    {
       ...
       //     supervisertxt.Text = "";
        ...
        void gridfill()
        {
            try
            {
                ...
                GlobalClass.adap = new MySqlDataAdapter("SELECT mbatch as `Batch No`, cubeno as `Cube No`, castdate as `Cast Date`, `date` as `Date`, loadinkn as `Loadinkn`, strength as `Strength` FROM tbldata_29_1 where mbatch = '" + batch + "' ;", myConn7);
     ...
     private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Opereation_Form29_1 op = new Opereation_Form29_1(str, i);
            op.Show();
        }
