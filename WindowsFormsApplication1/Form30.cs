    ...
    public partial class Form30 : Form
    {
        ...
        void nameplate()
        {
            ...
            try
            {
                ...
                connection.Open();
                var query = "select count(*) FROM nameplate30 where `date` like('" + theDate + "%') and batchno='" + batchcombo.SelectedItem.ToString() + "'  ;";
        ...
        void genraterpt()
        {
            ...
            try
            {
              ...
              //  parms[3] = new ReportParameter("Supervisor", supervisertxt.Text);
                ...
                this.tbldata_30TableAdapter.Fill(this.DataSet28.tbldata_30, batchcombo.SelectedItem.ToString());
        ...
        void retrivenameplate()
        {
            ...
            try
            {
                connection = new MySqlConnection(connectionString);
                connection.Open();
                var query = "select distinct * FROM nameplate30 where `date` like('" + theDate + "%') and batchno='" + batchcombo.SelectedItem.ToString() + "' ;";
        ...
        private void btnok_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string query = "INSERT INTO nameplate30 (`date`,  `batchno`,`shift`, `supervisor`) VALUES('" + dateTimePicker1.Value.ToString("yyyy-MM-dd") + "','" + batchcombo.SelectedItem.ToString() + "','" + shifttxt.Text + "',' ');";
        ...
        private void dataGridView1_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Opereation_Form30 op = new Opereation_Form30(str, i);
