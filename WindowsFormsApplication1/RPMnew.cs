    ...
    public partial class RPMnew : Form
    {
        ...
        private void btnok_Click(object sender, EventArgs e)
        {
            ...
            else if (rdodate.Checked == true)
            {
                ...
                string query = "INSERT INTO nameplaterpm (`date`,  `batchno`,`shift`, `supervisor`) VALUES('" + dateTimePicker1.Value.ToString("yyyy-MM-dd") + "','" + batchcombo.SelectedItem.ToString() + "','" + shifttxt.Text + "',' ');";
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Opereation_RPM op = new Opereation_RPM(str, i);
