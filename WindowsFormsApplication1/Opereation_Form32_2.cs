...
{
    public partial class Opereation_Form32_2 : Form
    {
        ...
        public Opereation_Form32_2()
        {
            InitializeComponent();
        }

        public Opereation_Form32_2(string id, int i)
        {
            InitializeComponent();
            userid = id;
            rowId = i;
        ...
        private void Opereation_Form32_2_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    dateTimePicker1.Text = GlobalClass.dt.Rows[rowId][19].ToString();
